...
public class BlackHole : MonoBehaviour
{
    ...
    void Start()
    {
        particleman = GameObject.FindGameObjectWithTag("ParticleManager").gameObject.GetComponent<ParticleManager>();
    ...
    IEnumerator startStrengh()
    {
        ...
        Destroy(clone2, 0.7f);
        particleman.GenerateExplosion(transform.position, 0);
